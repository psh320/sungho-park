...
export default function Introduction() {
  return (
    <>
      <div className="lg:flex-grow xs:w-1/2 md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        ...
        <p className="mb-4 leading-relaxed">
          Hello! My name is Sungho Park (Andrew) and I am year 4 Student in City
